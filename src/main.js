...
const dom = {
  ...
  jianghuBook: document.querySelector("#jianghu-book"),
  bookContent: document.querySelector("#book-content"),
  bookSummary: document.querySelector("#book-summary"),
  artPackSelect: document.querySelector("#artpack-select"),
  ...
  logOverlayList: document.querySelector("#log-overlay-list"),
